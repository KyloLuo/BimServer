...
//				LOGGER.info(requestUri);
			...
			if (request.getRequestURI().endsWith("getbimserveraddress")) {
				...
				//String siteAddress = bimServer.getServerSettingsCache().getServerSettings().getSiteAddress();//读取本地配置文件
				String siteAddress = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort() + request.getContextPath();//上面有问题，直接改为从请求端读取
