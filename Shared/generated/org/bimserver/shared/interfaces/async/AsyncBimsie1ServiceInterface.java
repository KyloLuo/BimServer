...
public class AsyncBimsie1ServiceInterface {
	...
	//@add by ch
	public interface testFunctionCallback {
	...
	public void addProject(final java.lang.String projectName, final java.lang.String schema,final java.lang.String description, final AddProjectCallback callback) {
		executorService.submit(new Runnable(){
			public void run(){
				try {
	...
	//@add by ch 
	public void testFunction(final java.lang.String projectName, final java.lang.String schema, final testFunctionCallback callback) {
		executorService.submit(new Runnable(){
			public void run(){
				try {
					callback.success(syncService.testFunction(projectName, schema));
				} catch (Throwable e) {
					callback.error(e);
				}
			}
